...
public class HibernateDrugInventoryDAOTest extends BaseModuleContextSensitiveTest {
	...
	public void testGetDrugInventoryByProvider() {
		List<DrugInventory> result = dao.getDrugInventoryByProvider(1);
		assertEquals(result.size(), 1);
		
	}
	
	@Test
	public void testGetDrugInventoryByLocation() {
		List<DrugInventory> result = dao.getDrugInventoriesByLocation(1);
		assertEquals(result.size(), 1);
